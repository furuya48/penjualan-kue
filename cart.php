...
<head>
  ...
  <title>Keranjang | Dani Snak</title>
      ...
      <div class="container">
              ...
              <?php 
                ...
                <?php foreach ($carts as $cart) : ?>
                  <?php 
                    ...
                    $banyak += $cart["banyak"];
                    $berat += ($product[0]["unit"] / 1000) * $cart["banyak"];
                    $total += $cart["total"];
                  ?>
                  <tr>
                    <td style="width: 20%;">
                    ...
                    <td style="width: 20%;">
                      <div class="product-title"><?= $cart["product_name"]; ?><?= $cart["unit"]; ?></div>
                      <div class="product-subtitle"><?= $cart["unit"]; ?> gram</div>
                    </td>
                    <td style="width: 10%;">
                      <div class="product-title"><?= $cart["banyak"]; ?></div>
                      <div class="product-subtitle">Buah</div>
                    </td>
                    <td style="width: 20%;">
        ...
        <form action="" method="POST">
          ...
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-4 col-md-3">
              <div class="product-title"><?= $berat; ?> Gram</div>
              <div class="product-subtitle">Berat Barang</div>
            </div>
            <div class="col-4 col-md-3">
              <?php if ($banyak >= 10) : ?>
              <div class="product-title text-success">Rp. <?= number_format($total+20000); ?></div>
              <?php else : ?>
